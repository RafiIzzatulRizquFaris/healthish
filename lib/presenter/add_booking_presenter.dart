...
class AddBookingPresenter implements AddBookingContractPresenter {
  ...
  Future<List<String>> getAddBookingData(
    ...
    String codeBooking =
        "B${splitTime[0].trim()}${splitTime[1].trim()}${splitDate[0].trim()}${splitDate[1].trim()}20";
    ...
    if (documentReference.documentID != null) {
      await http.post(
        ...
        headers: <String, String>{
          ...
          'Authorization':
              'key=AAAAhyxqd3Q:APA91bGwqwpgQsUDY_KmdTF5LJtC9rOJvyf1x4sMnj4Z_SiG-j7tHv7qiJggrhXwHQVVFfMXJ4azw5uYqqonnkeaiC3IZHC29tvQcG-V3b_0Yz9oezo_TYFKgRk8hb-muMOr2h3PrpMS',
        },
        body: jsonEncode(
          <String, dynamic>{
  ...
  loadAddBookingData(
      ...
      String message,
      String type) {
    getAddBookingData(idUser, idDoctor, idPatient, date, day, time, createAt,
            message, type)
